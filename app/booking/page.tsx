                ...
                <div className="grid lg:grid-cols-12 gap-12 items-start">
                    ...
                    <div className="lg:col-span-7">
                        <div className="mb-8 lg:mb-12">
                            <span className="bg-amber-100 text-amber-800 font-bold tracking-wider uppercase text-xs px-3 py-1 rounded-full inline-block mb-3">Secure Your Ride</span>
                            <h1 className="text-3xl md:text-5xl font-bold text-gray-900 mb-4 font-serif">Begin Your Journey</h1>
